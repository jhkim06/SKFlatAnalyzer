...
public:
    ...
    void create_2d_unfold_set(ISRUnfoldBin* bin1, ISRUnfoldBin* bin2, 
            double dipt_low_cut, double dipt_high_cut, double dimass_low_cut, double dimass_high_cut);
    ...
    void create_1d_unfold_set(ISRUnfoldBin* bin1, ISRUnfoldBin* bin2, 
            double dipt_low_cut, double dipt_high_cut, vector<double>& dimass_cuts);

    int get_bin_index(TUnfoldBinning* bin, const UnfoldSpaceName mode) const;

    void fill_unfold_fake_hist(ISRUnfoldSetUp* unfold_setup);
    ...
    void fill_unfold_matrixs(); 
    void fill_unfold_fake_hists(); 
    void fill_unfold_acceptance_hists(); 
    void fill_unfold_reco_hists(); 
    void fill_unfold_gen_hists(); 

    void fill_unfold_response_matrix(ISRUnfoldSetUp* unfold_setup);
